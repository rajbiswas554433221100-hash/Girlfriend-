...
const S = {
  ...
  startBtn: { marginTop: 6, padding: "13px 38px", borderRadius: 30, border: "none", background: "linear-gradient(135deg,#e879f9,#c084fc)", color: "#fff", fontSize: 16, fontWeight: "bold", cursor: "pointer", transition: "all 0.3s" },
  ...
  avatarSmall: { width: 28, height: 28, borderRadius: "50%", background: "linear-gradient(135deg,#e879f9,#c084fc)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: "bold", marginRight: 6 },
  ...
  settingsBtn: { background: "rgba(255,255,255,0.08)", border: "none", borderRadius: "50%", width: 32, height: 32, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, transition: "all 0.3s" },
